...
help:
	@echo 'Management commands for DSiSc/validator:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building validator ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/validator/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/validator/version.BuildDate=${BUILD_DATE}" ./...
